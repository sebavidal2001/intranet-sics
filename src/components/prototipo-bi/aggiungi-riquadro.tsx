      ...
      <div className="p-4">
        {scheda === "libreria" && (
          <div className="divide-y divide-border border-y border-border">
            {caricamentoLibreria ? <p className="flex items-center justify-center py-8 text-sm text-text-muted"><LoaderCircle className="mr-2 h-4 w-4 animate-spin" aria-hidden />Carico la libreria…</p> : analisi.length === 0 ? <p className="py-8 text-center text-sm text-text-muted">Nessuna analisi disponibile.</p> : analisi.map((voce) => {
