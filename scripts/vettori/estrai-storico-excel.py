...
BASE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "excel_vettori", "TEST VETTORI")
USCITA = os.path.join(os.path.dirname(os.path.abspath(__file__)), "storico_spedizioni_2026.csv")
